...
<?php require('../h&f/header.php'); ?>
    ...
    <div id="topic">
        <h2 id="section1">Coordinate Geometry</h2>
    </div>
...
<!--/.container-->
        <div id="sublogo2">
            <a href="CAT_QA_Polygons.php"><button type="button" class="prev" 
            style="margin-top:30px;">&laquo; Prev</button></a>
            <a href="CAT_QA_Mensuration.php"><button type="button" class="next" 
